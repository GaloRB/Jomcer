...
<div class="img-banner-water">
            <div class="title-banner-water">
                <h1>Suministro de agua potable</h1>
            </div>
            <div class="slogan-water">
                <span>Solicita tu servicio con pipas de diferente capacidad.</span>
            </div>
            <div class="button-contact">
                <button><a href="https://api.whatsapp.com/send?phone=+527292242272&text=Hola%21%20Quisiera%20m%C3%A1s%20informaci%C3%B3n%20sobre%20sus%20servicios." target="_blank">Pide tu pipa</a></button>
            </div>
        </div>
    </header>
    ...
    <section class="water-container animacion-arriba">
        ...
        <div class="list">
                <ul>
                    <li>Servicio de pipa a domicilio</li>
                    <li>Llenado de cisternas</li>
