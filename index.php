...
<?php include 'includes/nav.php' ?>
    ...
    <section class="quienes">
        <div class="title-quienes animacion-arriba">
    ...
    <section class="servicios">
        <div class="servicios-container">
            <div class="title-servicios animacion-arriba">
    ...
    <section class="imagen-contacto animacion-derecha">
        <div class="contenido-contacto">
            <h3>Construcción y Obras de Calidad</h3>
            <div class="imagen-contacto-text">
                <p>Estamos comprometidos con la mejora continua, brindando soluciones llave en mano con estándares de calidad superiores a los de la industria y servicios que integran las necesidades de nuestros clientes con nuestra sólida experiencia.</p>
            </div>
